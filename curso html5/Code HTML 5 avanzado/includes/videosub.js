// ==============================================================================
// VideoSub v0.9.6
// by Thomas Sturm, June 2010
// http://www.storiesinflight.com
// Freeware, Attribution Appreciated
// MooTools video event workaround courtesy of http://www.chipwreck.de
//
// Standards compliant video subtitles for HTML5 video tags. 
// Requires MooTools 1.3 or higher
...
// the subtitle file (SRT or WebSRT standard) and display the subtitles over
// the playing video. The library can handle multiple video files in one page.
// Should a browser already support <track> tags, VideoSub will detect that
